...
export default function DashboardNav({ fullName }: DashboardNavProps) {
  ...
  return (
    <nav className="bg-white border-b border-brand-mint/20 px-6 py-4">
      <div className="max-w-5xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <div className="hidden sm:flex items-center gap-2 bg-brand-cream rounded-full px-4 py-2">
            <div className="w-6 h-6 bg-brand-green rounded-full flex items-center justify-center text-white text-xs font-medium">
